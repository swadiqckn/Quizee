  ...
  return (
    <div className="space-y-24 pb-16">
      ...
      <section className="relative pt-12 pb-20 overflow-hidden">
        ...
        <div className="absolute right-4 sm:right-24 top-12 select-none pointer-events-none opacity-[0.07] font-black text-[22rem] sm:text-[30rem] leading-none text-[#e05a38] font-serif">
          ?
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#fff0ea] border border-[#ffd8cb] text-[#c2411d] text-xs font-black uppercase tracking-wider shadow-sm">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-2">
                ...
                >
                  ...
                  <div>
                    <p className="text-sm font-black leading-tight">Register your organization</p>
                ...
                >
                  ...
                  <div>
                    <p className="text-sm font-black leading-tight">Explore live quizzes</p>
            ...
            <div className="lg:col-span-5 relative space-y-4">
              ...
              <div className="p-4 sm:p-5 rounded-2xl bg-[#fff9f6] border-2 border-[#e05a38] shadow-lg max-w-sm ml-auto relative transition hover:-translate-y-1">
                <span className="text-[10px] font-black uppercase tracking-wider text-[#e05a38] block mb-1">
                  ORGANIZATION / SCHOOL
                </span>
              ...
              <div className="p-4 sm:p-5 rounded-2xl bg-[#fffbeb] border-2 border-[#f59e0b] shadow-lg max-w-sm mr-auto relative transition hover:-translate-y-1">
                <span className="text-[10px] font-black uppercase tracking-wider text-[#d97706] block mb-1">
                  REFERRALS & GROWTH
                </span>
                <p className="text-xs sm:text-sm font-bold text-slate-800">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="text-center max-w-2xl mx-auto space-y-3">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#fff0ea] border border-[#ffd5c4] text-[#c2411d] text-xs font-black uppercase tracking-wider">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-8 rounded-3xl bg-white border border-[#ebdcd1] shadow-sm hover:shadow-xl hover:border-[#e05a38]/40 transition group space-y-4">
            ...
            <h3 className="text-lg font-black text-slate-900">Multi-Stage Tournament Brackets</h3>
          ...
          <div className="p-8 rounded-3xl bg-white border border-[#ebdcd1] shadow-sm hover:shadow-xl hover:border-[#8b5cf6]/40 transition group space-y-4">
            ...
            <h3 className="text-lg font-black text-slate-900">Dynamic Speed-Decay Scoring</h3>
            <p className="text-sm text-slate-600 leading-relaxed">
          ...
          <div className="p-8 rounded-3xl bg-white border border-[#ebdcd1] shadow-sm hover:shadow-xl hover:border-[#ec4899]/40 transition group space-y-4">
            ...
            <h3 className="text-lg font-black text-slate-900">Isolated Tenant Organizations</h3>
            <p className="text-sm text-slate-600 leading-relaxed">
          ...
          <div className="p-8 rounded-3xl bg-white border border-[#ebdcd1] shadow-sm hover:shadow-xl hover:border-[#f59e0b]/40 transition group space-y-4">
            ...
            <h3 className="text-lg font-black text-slate-900">Anti-Cheat Randomization</h3>
            <p className="text-sm text-slate-600 leading-relaxed">
          ...
          <div className="p-8 rounded-3xl bg-white border border-[#ebdcd1] shadow-sm hover:shadow-xl hover:border-[#10b981]/40 transition group space-y-4">
            ...
            <h3 className="text-lg font-black text-slate-900">Technical Diagrams & Media</h3>
            <p className="text-sm text-slate-600 leading-relaxed">
          ...
          <div className="p-8 rounded-3xl bg-white border border-[#ebdcd1] shadow-sm hover:shadow-xl hover:border-[#3b82f6]/40 transition group space-y-4">
            ...
            <h3 className="text-lg font-black text-slate-900">Viral Referral Growth System</h3>
            <p className="text-sm text-slate-600 leading-relaxed">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="p-8 rounded-3xl bg-white border border-[#ebdcd1] shadow-xl space-y-6">
          {activeTab === 'tournament' && (
            <div className="space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-4">
                <div>
                  <h3 className="text-base font-black text-slate-900">Multi-Round Tournament Schedule</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-5 rounded-2xl bg-[#f0fdf4] border border-[#bbf7d0] space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-black text-[#15803d] uppercase">Level 1: Speed Prelims</span>
                    <span className="px-2 py-0.5 rounded text-[10px] bg-[#dcfce7] text-[#15803d] font-black">
                      ACTIVE
                    </span>
                  </div>
                ...
                <div className="p-5 rounded-2xl bg-[#fffbeb] border border-[#fde68a] space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-black text-[#b45309] uppercase">Level 2: Grand Finals</span>
                    <span className="px-2 py-0.5 rounded text-[10px] bg-[#fef3c7] text-[#b45309] font-black">
                      AUTO-SCHEDULED
                    </span>
                  </div>
          ...
          {activeTab === 'scoring' && (
            <div className="space-y-6">
              <div className="border-b border-slate-100 pb-4">
                <h3 className="text-base font-black text-slate-900">Dynamic Time-Decay Formula</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="p-5 rounded-2xl bg-[#f0fdf4] border border-[#bbf7d0] space-y-2">
                  ...
                  <p className="text-3xl font-black text-[#15803d]">10 / 10 pts</p>
                ...
                <div className="p-5 rounded-2xl bg-[#fffbeb] border border-[#fde68a] space-y-2">
                  ...
                  <p className="text-3xl font-black text-[#b45309]">4 / 10 pts</p>
                ...
                <div className="p-5 rounded-2xl bg-[#fff0ea] border border-[#ffd8cb] space-y-2">
                  ...
                  <p className="text-3xl font-black text-[#c2411d]">1 / 10 pts</p>
          ...
          {activeTab === 'monitor' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                <div>
                  <h3 className="text-base font-black text-slate-900">Real-Time Submissions Feed</h3>
              ...
              <div className="space-y-2">
                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 flex items-center justify-between text-xs">
                  <div className="flex items-center gap-3">
                    <span className="w-7 h-7 rounded-xl bg-[#fef3c7] text-[#b45309] font-black flex items-center justify-center">
                      #1
                    </span>
                    <div>
                      <p className="font-extrabold text-slate-900">Alex Chen (@alexchen)</p>
                      <p className="text-[10px] text-slate-500 font-medium">Speed: 12.4s • 3/3 Correct</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="font-black text-[#e05a38] text-sm">26 pts</span>
                    <span className="px-3 py-1 rounded-xl bg-[#15803d] text-white text-[10px] font-black">
                      Qualified
                    </span>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 flex items-center justify-between text-xs">
                  <div className="flex items-center gap-3">
                    <span className="w-7 h-7 rounded-xl bg-slate-200 text-slate-700 font-black flex items-center justify-center">
                      #2
                    </span>
                    <div>
                      <p className="font-extrabold text-slate-900">Sarah Jenkins (@sarah_j)</p>
                      <p className="text-[10px] text-slate-500 font-medium">Speed: 18.2s • 2/3 Correct</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="font-black text-[#e05a38] text-sm">19 pts</span>
                    <span className="px-3 py-1 rounded-xl bg-[#15803d] text-white text-[10px] font-black">
                      Qualified
                    </span>
                  </div>
          ...
          {activeTab === 'referrals' && (
            <div className="space-y-6">
              <div className="border-b border-slate-100 pb-4">
                <h3 className="text-base font-black text-slate-900">Viral Referral Growth Mechanics</h3>
                <p className="text-xs text-slate-500 mt-0.5">Automated attribution and bonus points incentives</p>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-5 rounded-2xl bg-[#fff0ea] border border-[#ffd8cb] space-y-2">
                  <span className="text-xs font-black text-[#c2411d]">Referrer Reward</span>
                  <p className="text-3xl font-black text-slate-900">+25 Points</p>
                  <p className="text-xs text-slate-600">Credited to referring contestant upon referee registration.</p>
                </div>

                <div className="p-5 rounded-2xl bg-[#f0fdf4] border border-[#bbf7d0] space-y-2">
                  <span className="text-xs font-black text-[#15803d]">Referee Welcome Bonus</span>
                  <p className="text-3xl font-black text-slate-900">+10 Points</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="p-8 rounded-3xl bg-white border border-[#ebdcd1] flex flex-col justify-between space-y-6 shadow-sm">
            <div className="space-y-4">
              <span className="px-3.5 py-1.5 rounded-full bg-slate-100 text-slate-700 text-xs font-black">
                Free Starter
              </span>
              <div>
            ...
            <Link
              href="/register"
              className="w-full py-3.5 rounded-2xl bg-slate-100 hover:bg-slate-200 text-slate-900 font-black text-xs text-center transition block"
            >
              Get Started Free
            </Link>
          </div>
          ...
          <div className="p-8 rounded-3xl bg-[#fff9f6] border-2 border-[#e05a38] flex flex-col justify-between space-y-6 shadow-xl relative overflow-hidden">
            <div className="absolute top-0 right-0 px-4 py-1 bg-[#e05a38] text-white text-[10px] font-black uppercase tracking-wider rounded-bl-xl">
              Most Popular
            </div>

            <div className="space-y-4">
              <span className="px-3.5 py-1.5 rounded-full bg-[#fff0ea] border border-[#ffd8cb] text-[#c2411d] text-xs font-black inline-flex items-center gap-1.5">
            ...
            <Link
              href="/admin/billing"
              className="w-full py-3.5 rounded-2xl bg-[#e05a38] hover:bg-[#c84a29] text-white font-black text-xs text-center shadow-lg shadow-[#e05a38]/30 transition block"
            >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="p-10 sm:p-14 rounded-3xl bg-[#fff5f0] border-2 border-[#ffd8cb] text-center space-y-6 shadow-xl relative overflow-hidden">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            <Link
              href="/register"
              className="px-8 py-4 rounded-2xl bg-[#e05a38] hover:bg-[#c84a29] text-white font-black text-sm shadow-xl shadow-[#e05a38]/25 transition hover:scale-105"
            >
              Register Organization (Free)
            </Link>
            <Link
              href="/explore"
              className="px-6 py-4 rounded-2xl bg-white hover:bg-slate-50 border-2 border-slate-900 text-slate-900 text-xs font-black transition"
            >
