  ...
  if (!currentUser || currentUser.role !== 'superadmin') {
    return (
      <div className="max-w-xl mx-auto py-20 text-center space-y-4">
        ...
        <h2 className="text-xl font-bold text-slate-900">Superadmin Access Required</h2>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-slate-900 mt-1">Tenant Organizations</h1>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div className="p-6 rounded-3xl bg-white border border-[#ebdcd1] shadow-sm space-y-2">
          ...
          <p className="text-3xl font-bold text-slate-900">{organisations.length}</p>
        ...
        <div className="p-6 rounded-3xl bg-white border border-[#ebdcd1] shadow-sm space-y-2">
          ...
          <p className="text-3xl font-bold text-slate-900">{quizzes.length}</p>
      ...
      {isAddingOrg && (
        <div className="p-8 rounded-3xl bg-white border-2 border-[#e05a38] space-y-6 shadow-xl">
          <div className="flex items-center justify-between border-b border-slate-100 pb-4">
            <h2 className="text-base font-bold text-slate-900">Add New Tenant Organization</h2>
      ...
      <div className="p-8 rounded-3xl bg-white border border-[#ebdcd1] space-y-6 shadow-sm">
        <h2 className="text-lg font-bold text-slate-900">Active Tenant Workspaces</h2>
