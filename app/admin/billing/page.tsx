  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
      ...
      <div className="text-center max-w-2xl mx-auto space-y-3">
        ...
        <h1 className="text-3xl sm:text-4xl font-black text-slate-900">Subscription & Plan Limits</h1>
      ...
      {upgradedSuccess && (
        <div className="p-4 rounded-2xl bg-[#f0fdf4] border-2 border-[#10b981] text-[#15803d] text-xs flex items-center justify-between shadow-md max-w-xl mx-auto">
          <div className="flex items-center gap-2.5">
            ...
            <p className="font-black">Plan updated successfully to {PLAN_CONFIG[currentPlan].name}!</p>
          </div>
        </div>
      )}
      ...
      <div className="p-8 rounded-3xl bg-white border border-[#ebdcd1] flex flex-col md:flex-row md:items-center justify-between gap-6 shadow-sm">
        ...
        <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 min-w-[260px] space-y-2">
          <div className="flex items-center justify-between text-xs font-bold">
            ...
            <span className={currentPlan === 'free' && currentQuizzesCount >= 2 ? 'text-rose-600 font-black' : 'text-slate-900 font-black'}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          <div className="space-y-6">
            ...
            <div className="space-y-3 pt-4 border-t border-slate-100">
              <p className="text-xs font-black text-slate-900 uppercase tracking-wider">Plan Highlights</p>
          ...
          <div className="pt-8">
            <button
              ...
              className="w-full py-3.5 rounded-2xl bg-slate-100 hover:bg-slate-200 disabled:opacity-50 text-slate-900 font-black text-xs transition"
            >
        ...
        >
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <span className="px-3.5 py-1.5 rounded-full bg-[#fff0ea] border border-[#ffd8cb] text-[#c2411d] text-xs font-black flex items-center gap-1.5">
                <Crown className="w-3.5 h-3.5" />
                Plus Pro
              </span>
              {currentPlan === 'plus' && (
                <span className="text-xs font-black text-[#e05a38] flex items-center gap-1">
            ...
            <div className="space-y-3 pt-4 border-t border-[#ffd8cb]">
              <p className="text-xs font-black text-slate-900 uppercase tracking-wider">Everything in Free, plus:</p>
          ...
          <div className="pt-8">
            <button
              ...
              className="w-full py-4 rounded-2xl bg-[#e05a38] hover:bg-[#c84a29] text-white font-black text-xs shadow-xl shadow-[#e05a38]/25 transition disabled:opacity-50 flex items-center justify-center gap-2"
            >
