                  ...
                  {quiz.quiz_type === 'tournament' ? (
                    isFocusRoundCompleted ? (
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        <button
                          disabled
                          className="inline-flex items-center gap-2 px-5 py-3.5 rounded-2xl bg-amber-100 border border-amber-300 text-amber-900 font-bold text-xs shadow-sm cursor-not-allowed opacity-90"
                        >
                        ...
                        {!currentUser ? (
                          <button
                            ...
                            className="inline-flex items-center gap-2 px-5 py-3.5 rounded-2xl bg-white hover:bg-slate-50 border-2 border-slate-900 text-slate-900 text-xs font-bold transition shadow-sm hover:scale-105"
                            title="Sign in with Google now so you are ready when the quiz starts"
                          >
                          ...
                          <div className="inline-flex items-center gap-2 px-4 py-3 rounded-2xl bg-emerald-50 border border-emerald-300 text-emerald-800 text-xs font-bold shadow-xs">
                            <CheckCircle2 className="w-4 h-4 text-emerald-600" />
                            <span>Signed In as @{currentUser.username} (Ready)</span>
                          </div>
                        )}
                      </div>
                    ) : (
